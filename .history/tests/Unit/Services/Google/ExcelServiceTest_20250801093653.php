...
class ExcelServiceTest extends TestCase
{
    ...
    public function testImportTransactionsFromSheet()
    {
        ...
        // Upewnij się, że kategorie zostały utworzone
        $this->assertDatabaseHas('categories', ['name' => 'Jedzenie', 'user_id' => $user->id]);
        $this->assertDatabaseHas('categories', ['name' => 'Rozrywka', 'user_id' => $user->id]);
